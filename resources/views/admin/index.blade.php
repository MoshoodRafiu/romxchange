        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <h4 class="small font-weight-bold">Customer Email Verifications<span class="float-right">{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_email_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%</span></h4>
                    <div class="progress mb-4">
                        <div class="progress-bar bg-info" aria-valuenow="{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_email_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_email_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%;"><span class="sr-only">{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_email_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%</span></div>
                    </div>
                    <h4 class="small font-weight-bold">Customer Phone Verifications<span class="float-right">{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_phone_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%</span></h4>
                    <div class="progress mb-4">
                        <div class="progress-bar bg-info" aria-valuenow="{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_phone_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_phone_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%;"><span class="sr-only">{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_phone_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%</span></div>
                    </div>
                    <h4 class="small font-weight-bold">Customer Document Verifications<span class="float-right">{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_document_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%</span></h4>
                    <div class="progress mb-4">
                        <div class="progress-bar bg-info" aria-valuenow="{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_document_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ round((\App\Verification::where('is_document_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%;"><span class="sr-only">{{ $trades->count() == 0 ? 0 : round((\App\Verification::where('is_document_verified', 1)->count() / \App\User::where('is_admin', 0)->where('is_agent', 0)->count()) * 100, 1) }}%</span></div>
                    </div>
