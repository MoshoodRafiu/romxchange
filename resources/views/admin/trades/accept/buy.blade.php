                ...
                <div class="card text-left">
                    <div class="card-header bg-special">
                        <ul class="nav nav-tabs card-header-tabs" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link step-info" id="item-1-3-tab" data-toggle="tab" role="tab" aria-controls="item-1-3" aria-selected="false" href="#item-1-3">Confirm Coin <i id="step-icon-3" class="fa @isset($trade) @if($trade->buyer_transaction_stage >= 3) fa-check-circle text-success @else fa-info-circle text-danger @endif @else fa-info-circle text-danger @endisset"></i></a></li>
                            <li class="nav-item"><a class="nav-link step-info" id="item-1-4-tab" data-toggle="tab" role="tab" aria-controls="item-1-4" aria-selected="false" href="#item-1-4">Make Payment <i id="step-icon-4" class="fa @isset($trade) @if($trade->buyer_transaction_stage >= 4) fa-check-circle text-success @else fa-info-circle text-danger @endif @else fa-info-circle text-danger @endisset"></i></a></li>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".step").on("click", "#step-1-proceed", function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.step1', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            $(".step").on('click', '#step-2-proceed', function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.step2', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            $(".step").on('click', '#step-3-proceed', function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.step3', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            $(".step").on('click', '#step-4-proceed', function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.step4', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            $("#item-1-1-tab").click(function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.nav.step1', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav2 = function(){
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.nav.step2', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav3 = function(){
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.nav.step3', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav4 = function(){
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.nav.step4', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav5 = function () {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.buy.nav.step5', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
