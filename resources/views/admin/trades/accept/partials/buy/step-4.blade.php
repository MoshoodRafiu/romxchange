...
            <input type="text" name="volume" value="{{ $trade->coin_amount }} {{ $trade->market->coin->abbr }}" class="form-control" disabled>
        ...
        <div class="form-group col-md-6">
            ...
            <div class="d-flex ">
                ...
                <a onclick="copyText('amountNGN')" class="col-2 text-white btn btn-secondary"><i class="fa fa-copy"></i></a>
            </div>
        </div>
...
            <div class="d-flex ">
                ...
                <span class="bg-dark text-white px-2 py-1 clipboard-message">Copied to clipboard</span>
                <a onclick="copyText('accountNumber')" class="col-sm-1 text-white col-2 btn btn-secondary"><i class="fa fa-copy"></i></a>
            </div>
        </div>
