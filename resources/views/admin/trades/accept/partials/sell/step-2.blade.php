...
<div class="text-center my-3">
    @if($trade->seller_transaction_stage == 1)
        <button id="step-2-proceed" class="btn btn-special p-2" type="button">I Have Received Payment</button>
    @else
        <button id="step-3-nav" class="btn btn-special p-2" type="button">Proceed</button>
    @endif
</div>
