                ...
                <div class="card text-left">
                    <div class="card-header bg-special">
                        <ul class="nav nav-tabs card-header-tabs" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link step-info" id="item-1-2-tab" data-toggle="tab" role="tab" aria-controls="item-1-2" aria-selected="false" href="#item-1-2">Acknowledge Payment <i id="step-icon-2" class="fa @isset($trade) @if($trade->seller_transaction_stage >= 2) fa-check-circle text-success @else fa-info-circle text-danger @endif @else fa-info-circle text-danger @endisset"></i></a></li>
                            <li class="nav-item"><a class="nav-link step-info" id="item-1-3-tab" data-toggle="tab" role="tab" aria-controls="item-1-3" aria-selected="false" href="#item-1-3">Coin Deposit <i id="step-icon-3" class="fa @isset($trade) @if($trade->seller_transaction_stage >= 3) fa-check-circle text-success @else fa-info-circle text-danger @endif @else fa-info-circle text-danger @endisset"></i></a></li>
                ...
                                            <input type="text" name="amount-ngn" value="{{ round($trade->coin_amount_ngn, 2) }}" class="form-control" disabled>
                    ...
                                            <input type="number" name="charges" value="{{ $trade->transaction_charge_coin }}" class="form-control" disabled>
                                        ...
                                        <div class="mx-auto text-center" id="trade-cancel">
                                            ...
                                            @else
                                                ...
                                                @if(!$trade->seller_transaction_stage == null)
                                                    <button type="submit" id="step-2-nav"  class="btn my-1 btn-special px-5">Proceed</button>
                                                @else
                                ...
                                <div id="chat-field" class="col-12 mx-auto p-0 mb-5">
                                    @isset($trade)
                                        @if($trade->is_dispute == 1)
                                            @include('admin.trades.accept.partials.sell.chat')
                                        @endif
                                    @endisset
                                </div>
                                <div class="col-12 mx-auto p-0">
                                    @include('admin.trades.accept.partials.sell.info')
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#step-1").submit(function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.step1') }}",
                    method: "POST",
                    data: {
                        trade: {{ $trade->id }},
            ...
            $(".step").on('click', '#step-2-proceed', function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.step2', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            $(".step").on('click', '#step-3-proceed', function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.step3', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            $(".step").on('click', '#step-4-proceed', function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.step4', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            $("#item-1-1-tab").click(function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.nav.step1', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav2 = function(){
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.nav.step2', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav3 = function(){
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.nav.step3', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav4 = function(){
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.nav.step4', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
            ...
            var nav5 = function () {
                ...
                $.ajax({
                    url: "{{ route('admin.trade.accept.sell.nav.step5', $trade) }}",
                    method: "GET",
                    cache: false,
                    beforeSend: function () {
                        $(".ajax-loader").show();
