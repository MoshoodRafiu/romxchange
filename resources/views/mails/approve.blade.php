                ...
                <div class="header"
                    ...
                    <div class="logo emb-logo-margin-box"
                        ...
                        <div class="logo-center" align="center" id="emb-email-header"><a
                                ...
                                href="{{ asset('assset/img/clogo.png') }}"><img
                                    style="display: block;height: auto;width: 100%;border: 0;max-width: 241px;"
                                    src="images/clogo.png" alt="" width="241"/></a></div>
                    </div>
                    <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                </div>
            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;">
                                        <strong>Account Restriction Resolution</strong></h1>
                                    <p style="Margin-top: 20px;Margin-bottom: 0;"><br/>
                                        Hi {{ $email_data['display_name'] }}, The restriction on you account has been
                                        resolved, you can now proceed to login you account below.</p>
                                </div>
                            </div>
                                    ...
                                    <table class="email-footer__links"
                                        ...
                                        <tr role="navigation">
                                            <td style="padding: 0;width: 26px;" emb-web-links><a
                                                    style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdbdbd;"
                                            ...
                                            <td style="padding: 0 0 0 3px;width: 26px;" emb-web-links><a
                                                    ...
                                                    href="#"><img style="border: 0;"
                                                                  ...
                                                                  width="26" height="26" alt="Website"/></a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" role="presentation">
                                <tr class="layout-email-footer">
                                    <td style="width: 600px;" class="w560"><![endif]-->
                            <div class="column"
                                 style="text-align: left;font-size: 12px;line-height: 19px;color: #bdbdbd;font-family: Ubuntu,sans-serif;">
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
