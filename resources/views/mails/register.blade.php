                    ...
                    <div class="layout__inner"
                        ...
                        <div class="column"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    ...
                                    <p style="Margin-top: 20px;Margin-bottom: 0;"><br/>
                                        Hi {{ $email_data['display_name'] }}, welcome to Acexworld, Please verify your email and activate your account.</p>
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                ...
                                <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="{{ url('/verify?code='.$email_data['verification_code']) }}" style="width:212px" arcsize="9%" fillcolor="#80BF2E" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Verify Email</center></v:textbox></v:roundrect><![endif]--></div>
                            </div>
