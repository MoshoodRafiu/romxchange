<div class="card shadow">
    ...
    <div class="card-body small">
        <table id="example" class="table table-responsive-sm text-left col-md-10 mx-auto" width="100%">
            ...
            <tr>
                <th>Rate<th>
                <td>{{ $trade->market->rate }} / USD<td>
            </tr>
            <tr>
                <th>Successful Trades<th>
                <td>{{ \App\Trade::where('transaction_status', 'success')->where(function ($query) use ($trade) {$query->where('buyer_id', $trade->buyer_id)->orWhere('seller_id', $trade->buyer_id);})->count() }}<td>
            </tr>
            <tr>
