...
<div class="card">
    ...
    <div class="card-footer bg-special">
        <div class="messages-area">
            ...
            <span class="message" id="message-2">Payment made</span>
            <span class="message" id="message-3">Confirm payment</span>
            <span class="message" id="message-4">I have sent payment proof</span>
        </div>
