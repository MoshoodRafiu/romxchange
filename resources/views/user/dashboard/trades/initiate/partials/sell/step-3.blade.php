...
@if($trade->is_special == 1)
    ...
    @elseif($trade->seller_transaction_stage == 2 && $trade->buyer_transaction_stage == 4)
        <div class="text-center" id="transaction-message">
            <strong class="text-success" style="font-size: 23px">Payment Made, Confirm Payment and Proceed</strong>
            <img width="100px" src="{{ asset('assets/img/proceed.gif') }}" alt="waiting">
        </div>
    @endif
@else
