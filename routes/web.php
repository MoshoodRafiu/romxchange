...
Route::group(['middleware' => ['auth', 'active']], function () {
    ...
    Route::post('/trades/cancel/check', 'TradeController@canCancelTrade')->name('trade.cancel.check');
...
Route::group(['middleware' => ['auth', 'agent']] , function () {
    ...
    Route::get('/admin/trades/disputes/filter', 'TradeController@disputeFilter')->name('admin.trades.disputes.filter');
